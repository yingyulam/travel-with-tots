...
from src.agents import _parse_json_reply
...
class CleanRepliesTest(unittest.TestCase):
    ...
    def test_surrounding_whitespace(self):
        self.assertEqual(_parse_json_reply('\n  {"a": 1}\n '), {"a": 1})
...
class WrappedRepliesTest(unittest.TestCase):
    ...
    def test_prose_before_a_fence(self):
        ...
        self.assertEqual(_parse_json_reply(reply), {"a": 1})
    ...
    def test_a_nested_object_keeps_its_braces(self):
        ...
        self.assertEqual(_parse_json_reply(reply),
